    ...
    <div class="comment__content">
      <div class="comment__header">
        <div class="comment__user">
          <picture  >
            <source type="image/webp" :src="require(`@/assets/${comment.user.image.webp}`)" class="comment__user-avatar"/>
            <img :src="require(`@/assets/${comment.user.image.png}`)" class="comment__user-avatar"/>
